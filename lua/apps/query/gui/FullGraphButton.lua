...
local FullGraphButton = ErrorOnInvalidRead.new{
    ...
    --
    -- Args:
    -- * object: table to turn into a FullGraphButton object (required field: appController, rawElement).
    --
    -- Returns: The argument turned into a FullGraphButton object.
    --
    new = function(object)
        cLogger:assertField(object, "app")
        cLogger:assertField(object, "rawElement")
