...
-- Subtype for LuaGuiElement objects of type "sprite-button".
--
...
-- + AbstractGuiElement
--
local SpriteButtonGuiElement = {
    -- Creates a new SpriteButtonGuiElement object.
    --
    -- Args:
    -- * args: table. Constructor argument of a LuaGuiElement in Factorio.
    -- * mockArgs: table. Same as AbstractGuiElement.abstractMake().
    --
    -- Returns: The new SpriteButtonGuiElement object.
    --
...
-- Metatable of the SpriteButtonGuiElement class.
Metatable = AbstractGuiElement.Metatable:makeSubclass{
    className = "SpriteButtonGuiElement",
...
ElementType = "sprite-button"

-- Set the "sprite" value of this element.
--
-- Args:
-- * selfData: table. Internal data of the SpriteButtonGuiElement.
...
AbstractGuiElement.registerClass(ElementType, SpriteButtonGuiElement)
return SpriteButtonGuiElement
